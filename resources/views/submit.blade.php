...
<head>
    ...
    <title>Ranconnity - Discord Verification Portal</title>
    ...
    <div class="verification-card">
        <div class="card-header">
            <h1 class="header-title glow-text">
                ...
                Ranconnity Role Requestor Form
            </h1>
            <p class="header-subtitle">
                Name a role, get exclusive perks, claim your role.
            </p>
        </div>
            ...
            @if(!session('discord_user'))
                <div class="discord-oauth-section mb-4">
                    <div class="text-center">
                        ...
                        <a href="{{ route('discord.login', ['return_url' => '/submit']) }}" class="btn-discord-login">
                            <i class="bi bi-discord me-2"></i>
                ...
                <div class="discord-connected-section mb-4">
                    <div class="discord-user-card">
                        <div class="d-flex align-items-center">
                            ...
                            @csrf
                            <input type="hidden" name="return_url" value="/submit">
            ...
            <form action="/submit" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-text">
                        ...
                        You must've known your own discord username ain't you lil bro?
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-text">
                        ...
                        Select the role that Elden Lord has given you
                    </div>
                </div>

                <div class="form-group">
                    <label for="desired_role" class="form-label">
                        <i class="bi bi-gem"></i>
                        Desired Role
                    </label>
                    <input type="text" 
                           ...
                           name="desired_role" 
                           class="form-control" 
                           placeholder="Rizzler, Aura Taxxer, Mogmaxxer, etc.." 
                           required>
                    <div class="form-text">
                        <i class="bi bi-magic"></i>
                        Type the custom role you want to achieve
                    </div>
                </div>
    ...
    <div class="text-center">
        <div class="butun-footer">
            <p class="text-secondary mb-0">
                ...
                Are you a member of BUTUN Vocational Highschoolers? 
                <a href="/submit/butun" class="butun-link">click here</a> 
                to obtain your special role!
            </p>
        </div>
    </div>
</div>
            ...
            discordIdInput.addEventListener('paste', function(e) {
                setTimeout(() => {
                    ...
                    if (originalValue !== cleanValue) {
                        ...
                        // Add visual feedback for paste cleanup
